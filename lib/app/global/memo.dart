...
class MemoHelper {
  ...
  static Future<void> createTables(sql.Database database) async {
    ...
    await database.execute('''CREATE TABLE memo_test25(
  ...
  static Future<sql.Database> db() async {
    //debug
    // print('create tables');
    return sql.openDatabase('memo_test25.db', version: 1,
  ...
  static Future<List<Map<String, dynamic>>> getItemsByContent(
    ...
    final db = await MemoHelper.db();
    return db.rawQuery(
        "SELECT * FROM memo_test25 WHERE content LIKE '%${content}%'");
  }
